...
For the most current incarnation of these materials, see here:
...
library(tidyverse)
gs4_deauth()
d <- read_sheet("https://docs.google.com/spreadsheets/d/1n2QUWu0zg8yBHvun0SdXrSfbhQq11ww79vICqW4mmrE/edit?usp=sharing", sheet = "199")
...
d |>
  ...
  tab_style(
    ...
    locations = cells_body(
      columns = everything(),
      rows = str_detect(topic, "[Ll]ab|Milestone|Review") 
