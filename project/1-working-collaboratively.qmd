...
#| message: false
#| echo: false
teams <- read_sheet("https://docs.google.com/spreadsheets/d/1tywYFySYTGFynqNm1R-ZXYFdypdRCC6QAbrn23PdBjk/edit?usp=sharing", sheet = paste0("lab-", 1))
...
#| message: false
#| echo: false
teams <- read_sheet("https://docs.google.com/spreadsheets/d/1tywYFySYTGFynqNm1R-ZXYFdypdRCC6QAbrn23PdBjk/edit?usp=sharing", sheet = paste0("lab-", 2))
make_pairing_table(teams)
```
...
#| message: false
#| echo: false
teams <- read_sheet("https://docs.google.com/spreadsheets/d/1tywYFySYTGFynqNm1R-ZXYFdypdRCC6QAbrn23PdBjk/edit?usp=sharing", sheet = paste0("lab-", 3))
make_pairing_table(teams)
```
...
#| message: false
#| echo: false
teams <- read_sheet("https://docs.google.com/spreadsheets/d/1tywYFySYTGFynqNm1R-ZXYFdypdRCC6QAbrn23PdBjk/edit?usp=sharing", sheet = paste0("lab-", 4))
make_pairing_table(teams)
```
...
#| message: false
#| echo: false
teams <- read_sheet("https://docs.google.com/spreadsheets/d/1tywYFySYTGFynqNm1R-ZXYFdypdRCC6QAbrn23PdBjk/edit?usp=sharing", sheet = paste0("lab-", 5))
make_pairing_table(teams)
```
...
#| message: false
#| echo: false
teams <- read_sheet("https://docs.google.com/spreadsheets/d/1tywYFySYTGFynqNm1R-ZXYFdypdRCC6QAbrn23PdBjk/edit?usp=sharing", sheet = paste0("lab-", 6))
make_pairing_table(teams)
```
...
#| message: false
#| echo: false
teams <- read_sheet("https://docs.google.com/spreadsheets/d/1tywYFySYTGFynqNm1R-ZXYFdypdRCC6QAbrn23PdBjk/edit?usp=sharing", sheet = paste0("lab-", 7))
make_pairing_table(teams)
```
...
#| message: false
#| echo: false
teams <- read_sheet("https://docs.google.com/spreadsheets/d/1tywYFySYTGFynqNm1R-ZXYFdypdRCC6QAbrn23PdBjk/edit?usp=sharing", sheet = paste0("lab-", 8))
make_pairing_table(teams)
```
...
#| message: false
#| echo: false
teams <- read_sheet("https://docs.google.com/spreadsheets/d/1tywYFySYTGFynqNm1R-ZXYFdypdRCC6QAbrn23PdBjk/edit?usp=sharing", sheet = paste0("lab-", 9))
make_pairing_table(teams)
```
...
#| message: false
#| echo: false
teams <- read_sheet("https://docs.google.com/spreadsheets/d/1tywYFySYTGFynqNm1R-ZXYFdypdRCC6QAbrn23PdBjk/edit?usp=sharing", sheet = paste0("lab-", 10))
make_pairing_table(teams)
```
:::
