...
In this lab gives you more practice on data wrangling and data pipelines, with an emphasis on mastering the subtleties of `group_by`, as well as introducing pivoting to the mix.
