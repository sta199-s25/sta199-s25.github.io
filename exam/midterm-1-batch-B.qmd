...
```{r}
#| include: false
pacman::p_load(tidyverse, scales, palmerpenguins, nycflights13, gt, openintro, janitor, knitr)
...
**Grading note:** Partial credit for `entity` instead of `country`.
:::
::::
...
{{< pagebreak >}} \## "I'll be Bach"

The following data frame, `composers`, contains information on the numbers of symphonies, operas, and concertos composed by two famous composers: Beethoven and Mozart.

```{r}
#| label: composers-tibble
#| echo: false
composers <- tibble(
  composer = c("Beethoven", "Beethoven", "Beethoven", "Mozart", "Mozart", "Mozart"), 
  genre = c("symphony", "opera", "concerto", "symphony", "opera", "concerto"), 
  count = c(9, 1, 9, 41, 22, 37)
)
```
