...
::: {.column width="20%"}
![](images/13/slido-qr-2024-10-24.png)
:::
:::

## Submit

<iframe src="https://app.sli.do/event/q455FV1ibTPoNGQBoMNMFJ" height="100%" width="100%" frameBorder="0" style="min-height: 500px;" allow="clipboard-write" title="Slido">
