...
If we add one exclamation mark to the model, we predict the odds of an email being spam to be **lower** by a factor of $e^{0.000272}\approx 1.000272$ on average.
