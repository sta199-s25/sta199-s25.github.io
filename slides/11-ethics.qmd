...
::: aside
Christopher Ingraham. ["You’ve been reading charts wrong. Here’s how a pro does it."](https://www.washingtonpost.com/business/2019/10/14/youve-been-reading-charts-wrong-heres-how-pro-does-it/). The Washington Post. 14 October 2019.
:::
...
::: {.column width="60%"}
![](images/11/pp-misleading.png)
:::
:::

::: aside
Timothy B. Lee. [Whatever you think of Planned Parenthood, this is a terrible and dishonest chart](https://www.vox.com/2015/9/29/9417845/planned-parenthood-terrible-chart). Vox. 29 September 2019.
:::
...
::: aside
Lazaro Gamio. ["Election maps are telling you big lies about small things"](https://www.washingtonpost.com/graphics/politics/2016-election/how-election-maps-lie/). The Washington Post. 1 Nov 2016.
:::
...
::: columns
::: column
![](images/11/citizens-for-trump.png){width="350"}
:::

::: column
![](images/11/counties-for-trump.png){width="350"}
:::
:::
...
## California Proposition 25 (2020) {.medium}
...
## What happens when we try "predictive policing"? {.small}
...
![](images/11/flo.png){width="24%"}
![](images/11/clue.png){width="24%"}
![](images/11/per_calendar.png){width="24%"}
![](images/11/stardust.png){width="24%"}
...
# Privacy (aka [the reason Tony Soprano ripped the GPS out of this Escalade](https://youtu.be/_FGmSqB6Jfo?feature=shared)
...
- AlphaFold2: "predicting 3D
structures [of proteins] ($y$) directly from the primary amino acid sequence ($x$)."
